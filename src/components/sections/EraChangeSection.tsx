  ...
  return (
    <section className="py-24 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-text-muted text-center max-w-2xl mx-auto mb-16 leading-relaxed">
          ...
          {comparisons.map((item, i) => (
            ...
            >
              <div className="bg-surface border border-border rounded-lg p-6 text-center">
                ...
                <p className="text-text-muted line-through">{item.before}</p>
              </div>
              <div className="text-primary text-2xl font-bold hidden md:block">
                →
              </div>
              <div className="bg-surface border border-primary/30 rounded-lg p-6 text-center">
                ...
                <p className="text-text-main font-bold">{item.after}</p>
              </div>
            </div>
          ))}
        </div>
